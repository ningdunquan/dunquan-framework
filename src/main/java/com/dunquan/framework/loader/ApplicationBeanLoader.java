package com.dunquan.framework.loader;
...
import com.dunquan.framework.manager.BeanManager;
import com.dunquan.framework.manager.XmlBeanManager;
...
public class ApplicationBeanLoader {
	...
	public ApplicationBeanLoader() {
		beanManager = new XmlBeanManager();
		setBeanMap(beanManager);
	}

	public ApplicationBeanLoader(String path) {
